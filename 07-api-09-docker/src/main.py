...
MODEL_PATH = os.path.join(MAIN_FOLDER, "modelo", "rf.pkl")
model = load_pickle_file(MODEL_PATH, "Model")

COLUMNS_PATH = os.path.join(MAIN_FOLDER, "modelo", "data_columns.pickle")
ohe_tr = load_pickle_file(COLUMNS_PATH, "Columns info")

BINS_PH_PATH = os.path.join(MAIN_FOLDER, "modelo", "saved_bins_ph.pickle")
new_saved_bins_ph = load_pickle_file(BINS_PH_PATH, "Bins for PH")

BINS_SULFATE_PATH =  os.path.join(MAIN_FOLDER, "modelo", "saved_bins_sulfate.pickle")
new_saved_bins_sulfate = load_pickle_file(BINS_SULFATE_PATH, "Bins for Sulfate")

BINS_TRIHALOMETHANES_PATH =  os.path.join(MAIN_FOLDER, "modelo", "saved_bins_trihalomethanes.pickle")
